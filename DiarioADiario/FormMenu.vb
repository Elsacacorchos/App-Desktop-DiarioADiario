...
Public Class Form1
    ...
    Private Sub btnProductos_Click(sender As Object, e As EventArgs) Handles btnProductos.Click
        Dim formUserProfile As New FormUserProfile()
        formUserProfile.Show()
    End Sub

    Private Sub btnDashBoard_Click(sender As Object, e As EventArgs) Handles btnDashBoard.Click
        AbrirFormEnPanel(New FormUsers)
    End Sub
    ...
    Private Sub loadUser()
        Label2.Text = ActiveUser.loginName
        Label3.Text = ActiveUser.email
        Label1.Text = ActiveUser.position

    End Sub

    Private Sub Logout1_Click(sender As Object, e As EventArgs) Handles Logout1.Click
        If MessageBox.Show("¿Seguro que quieres cerrar sesion?", "Advertencia",
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        AbrirFormEnPanel(New FormNotificaciones)
    End Sub
